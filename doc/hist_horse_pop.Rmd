...
bibliography: references_horses.bib
params:
  province: "Ontario"
output: 
  github_document:
...
```{r plot horses, fig.width=10, fig.height=3, fig.cap = "Figure 1. Horse population of all provinces in Canada between 1940 and 1972", out.width = "100%"}
...
```{r plot province, fig.width=5, fig.height=4, fig.cap = "Figure 2. Number of horses in the province of focus", out.width = "50%"}
